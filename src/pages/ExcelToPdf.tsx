...
const ExcelToPdf = () => {
  ...
  const handleFile = (selectedFile: File) => {
    if (
      ...
      alert(t('excel_to_pdf.error_file_type'));
      return;
    }
    if (selectedFile.size > 100 * 1024 * 1024) {
      // 100MB limit
      alert(t('excel_to_pdf.error_file_size'));
      return;
    }
  ...
  const startConversion = async () => {
    if (!file) {
      alert(t('excel_to_pdf.error_no_file'));
      return;
    }
      ...
      <div className=''>
          ...
          <div className='bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-6'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center'>
                <FileSpreadsheet className='text-green-500 w-6 h-6 mr-3' />
                <div>
        ...
        <div className='mb-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div className='option-group p-4 border border-gray-200 dark:border-gray-700 rounded-lg'>
              ...
              >
                {t('tools.excel_to_pdf.output_quality')}
              </label>
              <select
                id='pdf-quality'
        ...
        {!conversionComplete && !isConverting && file && (
          ...
          >
            ...
            {t('tools.excel_to_pdf.convert_button')}
          </button>
        )}
        ...
        {conversionComplete && (
          <div className='mt-6 p-4 bg-green-50 dark:bg-green-900 rounded-lg text-center'>
            ...
            <h3 className='text-lg font-semibold text-gray-800 dark:text-white mb-2'>
              {t('tools.excel_to_pdf.conversion_complete')}
            </h3>
            <p className='text-gray-600 dark:text-gray-400 mb-4'>
              {t('tools.excel_to_pdf.download_prompt')}
            </p>
            {pdfUrl && (
              <div className='mt-4'>
                <a
                ...
                >
                  {t('tools.excel_to_pdf.download_button')}
                </a>
              </div>
            )}
          </div>
