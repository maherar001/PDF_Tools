...
function PdfToPowerPoint() {
  ...
  return (
    <ToolPageLayout
      ...
      description='Easily convert your PDF files to editable PowerPoint presentations.'
    >
      <FileUpload
        ...
        {conversionComplete && (
          <div className='mt-6 p-4 bg-green-50 dark:bg-green-900 rounded-lg text-center'>
            ...
            <h3 className='text-lg font-semibold text-gray-800 dark:text-white mb-2'>
              {t('tools.pdf_to_powerpoint.conversion_complete')}
            </h3>
            <p className='text-gray-600 dark:text-gray-400 mb-4'>
              Your PDF document has been successfully converted to PowerPoint
              format.
            </p>
            {pptxUrl && (
              <div className='mt-4'>
